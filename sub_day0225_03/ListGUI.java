...
public class ListGUI extends JFrame {
	...
	ListGUI(ArrayList<ListVO> voList){
		...
		for(ListVO vo: voList ) {
			labelList[0] = new JLabel(vo.getNum());
			labelList[1] = new JLabel(vo.getName());
			labelList[2] = new JLabel(Integer.toString(vo.getKor()));
			labelList[3] = new JLabel(Integer.toString(vo.getEng()));
			labelList[4] = new JLabel(Integer.toString(vo.getMath()));
			labelList[5] = new JLabel(Integer.toString(vo.getTotal()));
			labelList[6] = new JLabel(Integer.toString(vo.getAver()));
